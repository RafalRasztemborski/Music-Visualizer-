...
// sketch.pop();
   ...
   // const t = easeInOut(beatProgress);
     ...
     // X_GAP = state.X_GAP + parseInt(bass * (120 / (bass + 1)))
      ...
      Y_GAP = paramsRef.current.Y_GAP  + Math.floor(smoothBass * (120 * (smoothBass + 1)))
      ...
      for (let x = 0; x < X_ROWS; x++) {
        for (let z = 0; z < Z_ROWS; z++) {
          ...
          const anim = sketch.sq(scVal * sinX[x] * sinZ[z] * bassAnim * 500);  
...
function SketchView({ sketchConfig, params, bands, onDebug, screenWidth, screenHeigh, setValues }) {
  ...
  return (
    <div className="relative">
      ...
      <div className="controls2">
          <Controls config={sketchConfig.controls} values={params} setValues={setValues} />
        </div>
      {/* <div class="test">
          {"ELO ELO "}
        </div> */}
...
function playAudio() {
  ...
  return (
    <div className="app" ref={containerRef}>
      {/* Left: Canvas */}
      {size.width > 0 && size.height > 0 && (<div className="canvas-container" >
        <SketchView 
